# Daedalus — build status

The honest working map. Every step of a complete install, each carrying a status marker,
so a human and an agent can share one account of what is actually built.

For what Daedalus is and how to install it, see [README.md](README.md).

> **Status: alpha.** Nothing here is aspirational — if it says DONE, it has been run.
>
